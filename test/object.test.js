...
describe('Object.merge', () => {
  ...
  test('Check if function "merge" works in case several sources arguments passed', () => {
    expect(
      object.merge(
        {
          a: [{ b: 2 }, { d: 4 }],
...
describe('Object.omit', () => {
  ...
  test('Check if function "omit" works in case no truthy elements in object for provided path', () => {
    expect(object.omit(obj, 'd')).toEqual({ a: 1, b: '2', c: 3 });
  });
  test('Check if function "omit" works in case obj argument provided is not object', () => {
    expect(object.omit(['a', 'b', 'c'], 'd')).toEqual({});
  });
});
...
describe('Object.omitBy', () => {
  ...
  test('Check if function "omitBy" works in case no truthy elements in object for provided function', () => {
    expect(object.omitBy(obj, isBoolean)).toEqual({ a: 1, b: '2', c: 3 });
  });
  test('Check if function "omitBy" works in case obj argument provided is not object', () => {
    expect(object.omitBy(['a', 'b', 'c'], isBoolean)).toEqual({});
  });
});
...
describe('Object.pick', () => {
  ...
  test('Check if function "pick" works in case no truthy elements in object for provided path', () => {
    expect(object.pick(obj, 'd')).toEqual({});
  });
  test('Check if function "pick" works in case obj argument provided is not object', () => {
    expect(object.pick(['a', 'b', 'c'], 'a')).toEqual({});
  });
});
...
describe('Object.pickBy', () => {
  ...
  test('Check if function "pickBy" works in case no truthy elements in object for provided function', () => {
    expect(object.pickBy(obj, isBoolean)).toEqual({});
  });
  test('Check if function "pickBy" works in case obj argument provided is not object', () => {
    expect(object.pickBy(['a', 'b', 'c'], isString)).toEqual({});
  });
});
